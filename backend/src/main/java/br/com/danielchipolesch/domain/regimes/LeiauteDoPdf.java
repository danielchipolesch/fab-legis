...
// é do regime -- página de Portaria + Capa + Sumário para um ato normativo; moldura com tabela de cabeçalho
// para uma NPA. A geração do arquivo (FOP, armazenamento, limite de concorrência) não depende do regime.
