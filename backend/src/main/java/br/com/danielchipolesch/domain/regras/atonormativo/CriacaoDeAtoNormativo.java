...
@Component
public class CriacaoDeAtoNormativo implements RegrasDeCriacaoDoDocumento {

    private final AssuntoBasicoRepository assuntoBasicoRepository;
    private final DocumentoRepository documentoRepository;

    public CriacaoDeAtoNormativo(AssuntoBasicoRepository assuntoBasicoRepository, DocumentoRepository documentoRepository) {
