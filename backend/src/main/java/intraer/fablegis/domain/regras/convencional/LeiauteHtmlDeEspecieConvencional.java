...
import intraer.fablegis.domain.services.VersoesDocumento;
...
public class LeiauteHtmlDeEspecieConvencional implements LeiauteDoHtml {
    ...
    private static String classpathDataUri(String path, String mimeType) {
        try (InputStream is = LeiauteHtmlDeEspecieConvencional.class.getResourceAsStream(path)) {
            if (is == null) return "";
    ...
    public String gerarHtml(
        ...
        return new Generator(doc, preliminares, normativos, anexos, brasaoRepublica, objectMapper, imagemService, numeracaoService, rotuloDosAnexos).gerar();
    }
    ...
    private static final class Generator {
        ...
        private final Map<Long, ElementoNumeracao> numeracao;
        ...
        private String buildAnexos() {
            ...
            for (var anexo : anexos) {
                sb.append("<div class=\"page-break\">\n");
                sb.append("<p class=\"anexo-titulo\">").append(esc(rotuloDosAnexos.rotulo(anexo.ordem()))).append("</p>\n");
