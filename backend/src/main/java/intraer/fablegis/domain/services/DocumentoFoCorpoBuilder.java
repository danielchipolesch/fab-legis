...
import static intraer.fablegis.domain.services.DocumentoFoContext.labelFo;
...
final class DocumentoFoCorpoBuilder {
    ...
    private boolean documentoPublicado() {
        return ctx.doc.getSituacaoBca() != intraer.fablegis.domain.entities.estruturaDocumento.SituacaoBcaEnum.NAO_PUBLICADO;
    }
